...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  header('Location: Listes_professeurs.php');
  exit;
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="/style/Listes_professeurs.css">
...
<aside class="aside2">
        ...
        <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
            ...
            <?php foreach ($professeurs as $professeur) : ?>
                <tr>
                  ...
                  <td><?= $professeur->getNom() . ' ' . $professeur->getPrenom(); ?></td>
                  <td><?= $professeur->getDateInscription(); ?></td>
                  <td><?= $professeur->getmetier(); ?></td>
                  <td class="drop-target">
                  <a href="Professeur.php?id=<?= $professeur->getId(); ?>">View details</a>
                  </td>
                </tr>
              <?php endforeach; ?> 
        </tbody>
    ...
    <div class="div3">
        ...
        <form class="professeur-form" method="post">
            ...
            <div class="form-group">
                <label for="metier">Occupation :</label>
